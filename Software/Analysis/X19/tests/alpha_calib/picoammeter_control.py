...
def Aug10b_test():
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_IsegFd1800.dat',extraStr=" 1800 1980", nrps=1000, nRead=5)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10a/Air_I_IsegFd3500.dat',extraStr=" 3500 3850", nrps=1000, nRead=2)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_DonwenFd1800_IsegFc2000.dat',extraStr=" 1800 3365 2000 3880", nrps=1000, nRead=5)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_DonwenFd1800_IsegFc2500.dat',extraStr=" 1800 4380 2500 4271", nrps=1000, nRead=5)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_DonwenFd1800_IsegFc2800.dat',extraStr=" 1800 4680 2800 4815", nrps=1000, nRead=5)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_DonwenFd1800_IsegFc1500.dat',extraStr=" 1800 3380 1500 2459", nrps=1000, nRead=5)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_DonwenFd1800_IsegFc2001.dat',extraStr=" 1800 3880 2000 3365", nrps=1000, nRead=5)
    run_quasicontinious_recording('/data/TMS_data/raw/Aug10b/Air_I_DonwenFd1800_IsegFc1800.dat',extraStr=" 1800 3680 1800 3002", nrps=1000, nRead=5)

def Aug12_test():
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_DonwenFd1500_IsegFc500.dat',extraStr=" 1500 2080 500 673", nrps=1000, nRead=5)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc500.dat',extraStr=" 1500 2080 500 673", nrps=1000, nRead=5)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_DonwenFd1500_IsegFc1000.dat',extraStr=" 1500 2580 1000 1607", nrps=1000, nRead=5)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_DonwenFd1500_IsegFc1500.dat',extraStr=" 1500 3080 1500 2540", nrps=1000, nRead=6)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc1500.dat',extraStr=" 1500 3080 1500 2540", nrps=1000, nRead=6)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc1000.dat',extraStr=" 1500 2580 1000 1607", nrps=1000, nRead=6)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc1800.dat',extraStr=" 1500 3380 1000 3100", nrps=1000, nRead=6)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc800.dat',extraStr=" 1500 2380 800 1233", nrps=1000, nRead=6)
#     run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc800.dat',extraStr=" 1500 2380 800 1233", nrps=1000, nRead=6)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13a/Air_I_set1_DonwenFd1500_IsegFc1000.dat',extraStr=" 1500 2580 1000 1607", nrps=1000, nRead=6)
    run_quasicontinious_recording('/data/TMS_data/raw/Aug13a/Air_totalI_HVscan_set1_DonwenFd3000.dat',extraStr=" 3000 3368", nrps=1000, nRead=4)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_DonwenFd1500_IsegFc2000.dat',extraStr=" 1500 3580 2000 3473", nrps=1000, nRead=5)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_set1_DonwenFd1500_IsegFc2000.dat',extraStr=" 1500 3580 2000 3473", nrps=1000, nRead=5)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug12a/Air_I_DonwenFd1500_IsegFc2300.dat',extraStr=" 1500 3880 2300 4033", nrps=1000, nRead=5)

def Aug13_test():
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Air_I_set1_DonwenFd1500_IsegFc2000.dat',extraStr=" 1500 3580 2000 3473", nrps=1000, nRead=3)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Air_totalI_set1_IsegFc1500.dat',extraStr=" 1500 1784", nrps=1000, nRead=15)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Ar_I_DonwenFd1500_IsegFc2000.dat',extraStr=" 1500 3580 2000 3473", nrps=1000, nRead=-1)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Ar_I_DonwenFd1500_IsegFc1500.dat',extraStr=" 1500 3080 1500 2540", nrps=1000, nRead=-1)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Ar_totalI_set4in1_IsegFc1500.dat',extraStr=" 1500 1784", nrps=1000, nRead=-1)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Ar_I_set4in1_DonwenFd1500_IsegFc1500_contOvernight.dat',extraStr=" 1500 3080 1500 2540", nrps=1000, nRead=-1)
#    run_quasicontinious_recording('/data/TMS_data/raw/Aug13b/Ar_I_set4in1_IsegFd1500_morning.dat',extraStr=" 1500 1784", nrps=1000, nRead=-1)
...
#      run_quasicontinious_recording_withT('/data/TMS_data/raw/Aug31a/Ar_I_DonwenFd1500_IsegFc1500_gasOff_Sep021226.dat',extraStr=" 1500 3080 1500 2540 0.976 0.494", nrps=1000, nRead=-1)
#      run_quasicontinious_recording_withT('/data/TMS_data/raw/Aug31a/Ar_I_IsegFd1500_gasOff_Sep021429.dat',extraStr=" 1500 3080 1500 2540 0.976 0.494", nrps=1000, nRead=-1)
#      run_quasicontinious_recording_withT('/data/TMS_data/raw/Sep03a/Ar_I_IsegFd1500_gasMin_Sep031724.dat',extraStr=" 1500 1784 -999 -999 -999 -999", nrps=1000, nRead=-1)
