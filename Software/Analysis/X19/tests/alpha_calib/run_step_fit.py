...
def process_ds(fname = '/data/TMS_data/raw/Jun25a/Argon_totalI.dat', startIdx=None, stopTag=None, infoText=None, HVtripFix=False, excludeDS=[],sName=None, summary_file='summary.ttl', show=None):
...
#     process_ds(dir1+'Aug27c/Ar_I_DonwenFd1500_IsegFc1500_gasMin_Aug281840.dat', startIdx=72970, excludeDS=[], summary_file=dir3+'Aug27c/Ar_I_DonwenFd1500_IsegFc1500_gasMin_Aug272015.ttl', show='all')
    #process_ds(dir1+'Aug27d/Ar_I_IsegFc4000_gasMin_Aug291705.dat', startIdx=1450, excludeDS=[], summary_file=dir3+'Aug27d/Ar_I_IsegFc4000_gasMin.ttl', show='all')
...
#    process_ds(dir1+'Sep22a/Ar_I_DongwenFd1500_IsegFc1500_gasOFF_Pressurefrom15PSI_Sep222133.dat',  excludeDS=[], summary_file=dir3+'Sep22a/summary.ttl', show='None')
#    process_ds(dir1+'Sep24a/Ar_I_IsegFd1500_gasOFF_Pressurefrom28PSI_Sep241645.dat',  excludeDS=[], summary_file=dir3+'Sep24a/summary.ttl', show='all')
#    process_ds(dir1+'Sep30a/P10_I_IsegFd1500_P10OFF_Sep301846.dat',  excludeDS=[], summary_file=dir3+'Sep30a/summary.ttl', show='all')
#    process_ds(dir1+'Oct05a/P10_I_DonwenFd1500_IsegFc1500_P10OFF_Oct051552.dat',  excludeDS=[], summary_file=dir3+'Oct05a/summary.ttl', show='all')
    process_ds(dir1+'Oct05a/P10_I_IsegFd1500_P10OFF_Oct051705.dat',  excludeDS=[], summary_file=dir3+'Oct05a/summary.ttl', show='all')
