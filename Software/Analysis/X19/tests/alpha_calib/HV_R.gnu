...
#plot dir1."R1_Iseg8.dat" using (-1.*$5):(-1.*$2)
#plot dir1."R2_pico1.dat" using 5:(-1.*$2), dir1."R2_Iseg0.dat" using (-1.*$5):(-1.*$2), dir1."R2_Iseg1.dat" using (-1.*$5):(-1.*$2)
plot dir1."R2_pico1.dat" using 5:(-1.*$2) title "Picoammeter", dir1."R2_Iseg0.dat" using (-1.*$5):(-1.*$2) title "Iseg-test0", dir1."R2_Iseg1.dat" using (-1.*$5):(-1.*$2) title "Iseg-test1"
