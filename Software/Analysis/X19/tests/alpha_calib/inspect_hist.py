...
#     loopMonitor('/data/TMS_data/Processed/Jul30a_p1/*.root', ['/data/TMS_data/Processed/Jul30a_p1/*_0.root','/data/TMS_data/Processed/Jul30a_p1/*_1.root'], promsVarX=('proms3*0.2','proms3(225,5,50)'))
#     loopMonitor('/data/TMS_data/Processed/Jul30a_p1/*.root', ['/data/TMS_data/Processed/Jul30a_p1/*_0.root','/data/TMS_data/Processed/Jul30a_p1/*_41.root', '/data/TMS_data/Processed/Jul30a_p1/*_44.root', '/data/TMS_data/Processed/Jul30a_p1/*_89.root'], promsVarX=('proms3*0.2','proms3(230,4,50)'))
#     loopMonitor('/data/TMS_data/Processed/Aug27b_p0/*.root', ['/data/TMS_data/Processed/Aug27a_p0/*_0.root','/data/TMS_data/Processed/Aug27a_p0/*_41.root', '/data/TMS_data/Processed/Aug27a_p0/*_50.root', '/data/TMS_data/Processed/Aug27a_p0/*_399.root'], promsVarX=('proms3*0.2','proms3(250,0,50)'))
    loopMonitor('/data/TMS_data/Processed/Sep03a_p0/*.root', ['/data/TMS_data/Processed/Aug31a_p0/*500Hz*_14022.root', '/data/TMS_data/Processed/Sep03a_p0/*500Hz*.root'], promsVarX=('proms3*0.2','proms3(250,0,50)'))
