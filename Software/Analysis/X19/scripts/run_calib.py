...
#     vlist.append(('v20mV', 0.02, 'w2[19]>200&&(im[0]-im[19])>900&&(im[0]-im[19])<950&&run>100&&run<120'))
    ...
    vlist.append(('v40mV',  0.04, 'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>-1&&run<48'))
    vlist.append(('v200mV', 0.2,  'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>48&&run<70'))
    vlist.append(('v320mV', 0.32, 'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>70&&run<83'))
    vlist.append(('v80mV',  0.08, 'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>83&&run<92'))
    vlist.append(('v400mV', 0.4,  'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>92&&run<109'))
    vlist.append(('v20mV',  0.02, 'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>109&&run<117'))
    vlist.append(('v120mV', 0.12, 'w2[19]>200&&(im[{0:d}]-im[19])>900&&(im[{0:d}]-im[19])<950&&run>117&&run<133'))
